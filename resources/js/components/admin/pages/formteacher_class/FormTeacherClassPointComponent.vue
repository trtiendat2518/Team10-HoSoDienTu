                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="7" class="td-title">
                                                1.1. Sinh viên có điểm trung bình học kỳ: ({{ formteacher.item_one.one_parent.header }} đ)
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="3%"></td>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_one.one_parent.score.one }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    v-model="formteacher.item_one.one_parent.input.one"
                                                    class="input-point"
                                                    type="text"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_one.one_parent.input.one }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_one.one_parent.score.two }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_one.one_parent.input.two"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_one.one_parent.input.two }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_one.one_parent.score.three }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_one.one_parent.input.three"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_one.one_parent.input.three }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_one.one_parent.score.four }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_one.one_parent.input.four"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_one.one_parent.input.four }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_one.one_parent.score.five }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_one.one_parent.input.five"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_one.one_parent.input.five }}</td>
                                            <td class="text-center">{{ deanfaculty.item_one.one_parent.input.five }}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="7" class="td-title">
                                                1.2. Sinh viên có ý thức học tập: ({{ formteacher.item_one.two_parent.header }} đ)
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="3%"></td>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_one.two_parent.score.one }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_one.two_parent.input.one"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_one.two_parent.input.one }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_one.two_parent.score.two }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_one.two_parent.input.two"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_one.two_parent.input.two }}</td>
                                        ...
                                        <tr>
                                            <td width="7%" colspan="2" class="td-title">
                                                ...
                                                cấp Khoa trở lên. ({{ formteacher.item_one.three_parent.header }} đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_one.three_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_one.three_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_one.three_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td width="7%" colspan="2" class="td-title">
                                                ...
                                                mềm do các đơn vị trực thuộc Trường hoặc các đơn vị phối hợp với Trường tổ chức. ({{
                                                    formteacher.item_one.four_parent.header
                                                }}
                                                đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_one.four_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_one.four_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_one.four_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td width="7%" colspan="2" class="td-title">
                                                1.5. Sinh viên có tham gia dự thi cuộc thi về học thuật từ cấp Khoa trở lên. ({{
                                                    formteacher.item_one.five_parent.header
                                                }}
                                                đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_one.five_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_one.five_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_one.five_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td width="7%" colspan="2" class="td-title">
                                                1.6. Sinh viên có tham gia đề tài nghiên cứu khoa học từ cấp Khoa trở lên. ({{
                                                    formteacher.item_one.six_parent.header
                                                }}
                                                đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_one.six_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_one.six_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_one.six_parent.input }}</td>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="49%" colspan="2" class="td-title">
                                                2.1. Sinh viên tuân thủ quy chế thi của Nhà trường. ({{
                                                    formteacher.item_two.one_parent.header
                                                }}
                                                đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_two.one_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_two.one_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_two.one_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td width="49%" colspan="2" class="td-title">
                                                2.2. Hoàn thành học phí đúng thời hạn theo quy định của Nhà Trường. ({{
                                                    formteacher.item_two.two_parent.header
                                                }}
                                                đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_two.two_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_two.two_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_two.two_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td width="49%" colspan="2" class="td-title">
                                                ...
                                                Khoa, của Nhà trường. ({{ formteacher.item_two.three_parent.header }} đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_two.three_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_two.three_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_two.three_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td width="49%" colspan="2" class="td-title">
                                                ...
                                                chế khác của Nhà trường. ({{ formteacher.item_two.four_parent.header }}
                                                đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_two.four_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_two.four_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_two.four_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td width="49%" colspan="2" class="td-title">
                                                ...
                                                vướng mắc,… ({{ formteacher.item_two.five_parent.header }} đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_two.five_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_two.five_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_two.five_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td width="49%" colspan="2" class="td-title">
                                                ...
                                                đầu năm học của Khoa, Trường. ({{ formteacher.item_two.six_parent.header }} đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_two.six_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_two.six_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_two.six_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td width="49%" colspan="2" class="td-title">
                                                ...
                                                học của Khoa, Trường. ({{ formteacher.item_two.seven_parent.header }} đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_two.seven_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_two.seven_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_two.seven_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td width="49%" colspan="2" class="td-title">
                                                ...
                                                chấp hành nội quy, quy chế, quy định Nhà trường. ({{
                                                    formteacher.item_two.eight_parent.header
                                                }}
                                                đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_two.eight_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_two.eight_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_two.eight_parent.input }}</td>
                                ...
                                <table class="table table-bordered white-table">
                                    <tbody>
                                        <tr>
                                            <td colspan="7" class="td-title">
                                                3.1. Sinh viên tham gia đầy đủ các buổi sinh hoạt lớp, chi Hội / chi Đoàn ({{
                                                    formteacher.item_three.one_parent.header
                                                }}
                                                đ)
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_three.one_parent.score.one }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_three.one_parent.input.one"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_three.one_parent.input.one }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_three.one_parent.score.two }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_three.one_parent.input.two"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_three.one_parent.input.two }}</td>
                                        ...
                                        <tr>
                                            <td width="7%" colspan="2" class="td-title">
                                                ...
                                                phạm và các tệ nạn xã hội. ({{ formteacher.item_three.two_parent.header }} đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_three.two_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_three.two_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_three.two_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td width="7%" colspan="2" class="td-title">
                                                ...
                                                đơn vị trực thuộc nhà Trường tổ chức. ({{ formteacher.item_three.three_parent.header }} đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_three.three_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_three.three_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_three.three_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td colspan="7" class="td-title">
                                                ...
                                                lên: ({{ formteacher.item_three.four_parent.header }}
                                                đ)
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_three.four_parent.score.one }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_three.four_parent.input.one"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_three.four_parent.input.one }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_three.four_parent.score.two }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_three.four_parent.input.two"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_three.four_parent.input.two }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_three.four_parent.score.three }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_three.four_parent.input.three"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_three.four_parent.input.three }}</td>
                                        ...
                                        <tr>
                                            <td colspan="7" class="td-title">
                                                ...
                                                nguyện, cộng đồng, công tác xã hội; văn hóa; văn nghệ; thể thao từ cấp Khoa trở lên: ({{
                                                    formteacher.item_three.five_parent.header
                                                }}
                                                đ)
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_three.five_parent.score.one }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_three.five_parent.input.one"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_three.five_parent.input.one }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_three.five_parent.score.two }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_three.five_parent.input.two"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_three.five_parent.input.two }}</td>
                                        ...
                                        <tr>
                                            <td width="7%" colspan="2" class="td-title">
                                                ...
                                                chức. ({{ formteacher.item_three.six_parent.header }}
                                                đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_three.six_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_three.six_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_three.six_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td width="7%" colspan="2" class="td-title">
                                                ...
                                                Lênin, Tư tưởng Hồ Chí Minh từ cấp Khoa trở lên. ({{
                                                    formteacher.item_three.seven_parent.header
                                                }}
                                                đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_three.seven_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_three.seven_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_three.seven_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td colspan="7" class="td-title">
                                                ...
                                                thể thao, phòng chống tội phạm và các tệ nạn xã hội từ cấp trường trở lên: ({{
                                                    formteacher.item_three.eight_parent.header
                                                }}
                                                đ)
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_three.eight_parent.score.one }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_three.eight_parent.input.one"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_three.eight_parent.input.one }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_three.eight_parent.score.two }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_three.eight_parent.input.two"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_three.eight_parent.input.two }}</td>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="49%" colspan="2" class="td-title">
                                                ...
                                                nước trong cộng đồng. ({{ formteacher.item_four.one_parent.header }} đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_four.one_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_four.one_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_four.one_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td width="49%" colspan="2" class="td-title">
                                                ...
                                                viên Nhà trường và bạn bè xung quanh. ({{ formteacher.item_four.two_parent.header }} đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_four.two_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_four.two_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_four.two_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td width="49%" colspan="2" class="td-title">
                                                4.3. Sinh viên tuân thủ quy định về việc tham gia bảo hiểm y tế. ({{
                                                    formteacher.item_four.three_parent.header
                                                }}
                                                đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_four.three_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_four.three_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_four.three_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td width="49%" colspan="2" class="td-title">
                                                ...
                                                quỹ Gia đình Văn Lang, tặng sách đồng môn, hỗ trợ đồng bào bị ảnh hưởng thiên tai,… ({{
                                                    formteacher.item_four.four_parent.header
                                                }}
                                                đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_four.four_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_four.four_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_four.four_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td width="49%" colspan="2" class="td-title">
                                                ...
                                                kiện. ({{ formteacher.item_four.five_parent.header }}
                                                đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_four.five_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_four.five_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_four.five_parent.input }}</td>
                                            <td class="text-center">{{ deanfaculty.item_four.five_parent.input }}</td>
                                        </tr>
                                        <tr>
                                            <td width="49%" colspan="2" class="td-title">
                                                4.6. Sinh viên tham gia hiến máu tình nguyện tại Trường. ({{
                                                    formteacher.item_four.six_parent.header
                                                }}
                                                đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_four.six_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_four.six_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_four.six_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td width="49%" colspan="2" class="td-title">
                                                ...
                                                xuân tình nguyện,… ({{ formteacher.item_four.seven_parent.header }} đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_four.seven_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_four.seven_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_four.seven_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td width="49%" colspan="2" class="td-title">
                                                4.8. Sinh viên có tham gia các hoạt động vì cộng đồng tại địa phương. ({{
                                                    formteacher.item_four.eight_parent.header
                                                }}
                                                đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_four.eight_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_four.eight_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_four.eight_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td width="49%" colspan="2" class="td-title">
                                                4.9. Sinh viên được khen thưởng đã có hoạt động vì cộng đồng tại địa phương. ({{
                                                    formteacher.item_four.nine_parent.header
                                                }}
                                                đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_four.nine_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_four.nine_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_four.nine_parent.input }}</td>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="7%" colspan="2" class="td-title">
                                                ...
                                                hoàn thành nhiệm vụ và tập thể công nhận. ({{ formteacher.item_five.one_parent.header }} đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_five.one_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_five.one_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_five.one_parent.input }}</td>
                                        ...
                                        <tr>
                                            <td width="7%" colspan="2" class="td-title">
                                                ...
                                                nhiệm vụ và tập thể lớp công nhận. ({{ formteacher.item_five.two_parent.header }} đ)
                                            </td>
                                            <td class="text-center" width="10%">{{ formteacher.item_five.two_parent.score }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_five.two_parent.input"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_five.two_parent.input }}</td>
                                            <td class="text-center">{{ deanfaculty.item_five.two_parent.input }}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="7" class="td-title">
                                                5.3. Xếp loại Tập thể lớp được Ban Chủ nhiệm Khoa đánh giá: ({{
                                                    formteacher.item_five.three_parent.header
                                                }}
                                                đ)
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_five.three_parent.score.one }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_five.three_parent.input.one"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_five.three_parent.input.one }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_five.three_parent.score.two }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_five.three_parent.input.two"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_five.three_parent.input.two }}</td>
                                        ...
                                        <tr>
                                            <td colspan="7" class="td-title">
                                                5.4. Xếp loại Chi Đoàn/Chi Hội được Đoàn/Hội cấp trên công nhận: ({{
                                                    formteacher.item_five.four_parent.header
                                                }}
                                                đ)
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_five.four_parent.score.one }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_five.four_parent.input.one"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_five.four_parent.input.one }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_five.four_parent.score.two }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_five.four_parent.input.two"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_five.four_parent.input.two }}</td>
                                        ...
                                        <tr>
                                            <td colspan="7" class="td-title">
                                                5.5. Sinh viên là cán bộ Đoàn Hội được Đoàn – Hội trường công nhận: ({{
                                                    formteacher.item_five.five_parent.header
                                                }}
                                                đ)
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_five.five_parent.score.one }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_five.five_parent.input.one"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_five.five_parent.input.one }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_five.five_parent.score.two }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_five.five_parent.input.two"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_five.five_parent.input.two }}</td>
                                        ...
                                        <tr>
                                            <td colspan="7" class="td-title">
                                                5.6. Sinh viên có giải thưởng trong học tập và rèn luyện: ({{
                                                    formteacher.item_five.six_parent.header
                                                }}
                                                đ)
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_five.six_parent.score.one }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_five.six_parent.input.one"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_five.six_parent.input.one }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_five.six_parent.score.two }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_five.six_parent.input.two"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_five.six_parent.input.two }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%">{{ formteacher.item_five.six_parent.score.three }}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                <input
                                                    ...
                                                    class="input-point"
                                                    type="text"
                                                    v-model="formteacher.item_five.six_parent.input.three"
                                                />
                                            </td>
                                            <td class="text-center" width="10%">{{ deanfaculty.item_five.six_parent.input.three }}</td>
...
export default {
    ...
    methods: {
        ...
        fetchCalendarRegister(page_url) {
            page_url = `../../api/student/train-point/danh-gia-diem-ren-luyen/thoi-gian-danh-gia-chu-nhiem/${this.student_id}`
            fetch(page_url)
                .then(res => res.json())
                .then(res => {
        ...
        store() {
            ...
            let sum_itemOne_oneParent =
                Number(this.formteacher.item_one.one_parent.input.one) +
                Number(this.formteacher.item_one.one_parent.input.two) +
                Number(this.formteacher.item_one.one_parent.input.three) +
                Number(this.formteacher.item_one.one_parent.input.four) +
                Number(this.formteacher.item_one.one_parent.input.five)
            if (sum_itemOne_oneParent > this.formteacher.item_one.one_parent.header) {
                sum_itemOne_oneParent = this.formteacher.item_one.one_parent.header
            }

            let sum_itemOne_twoParent =
                Number(this.formteacher.item_one.two_parent.input.one) + Number(this.formteacher.item_one.two_parent.input.two)
            if (sum_itemOne_twoParent > this.formteacher.item_one.two_parent.header) {
                sum_itemOne_twoParent = this.formteacher.item_one.two_parent.header
            }

            let sum_itemOne =
                sum_itemOne_oneParent +
                sum_itemOne_twoParent +
                Number(this.formteacher.item_one.three_parent.input) +
                Number(this.formteacher.item_one.four_parent.input) +
                Number(this.formteacher.item_one.five_parent.input) +
                Number(this.formteacher.item_one.six_parent.input)
            ...
            // item two
            let sum_itemTwo =
                Number(this.formteacher.item_two.one_parent.input) +
                Number(this.formteacher.item_two.two_parent.input) +
                Number(this.formteacher.item_two.three_parent.input) +
                Number(this.formteacher.item_two.four_parent.input) +
                Number(this.formteacher.item_two.five_parent.input) +
                Number(this.formteacher.item_two.six_parent.input) +
                Number(this.formteacher.item_two.seven_parent.input) +
                Number(this.formteacher.item_two.eight_parent.input)
            ...
            let sum_itemThree_oneParent =
                Number(this.formteacher.item_three.one_parent.input.one) + Number(this.formteacher.item_three.one_parent.input.one)
            if (sum_itemThree_oneParent > this.formteacher.item_three.one_parent.header) {
                sum_itemThree_oneParent = this.formteacher.item_three.one_parent.header
            }

            let sum_itemThree_fourParent =
                Number(this.formteacher.item_three.four_parent.input.one) +
                Number(this.formteacher.item_three.four_parent.input.two) +
                Number(this.formteacher.item_three.four_parent.input.three)
            if (sum_itemThree_fourParent > this.formteacher.item_three.four_parent.header) {
                sum_itemThree_fourParent = this.formteacher.item_three.four_parent.header
            }

            let sum_itemThree_fiveParent =
                Number(this.formteacher.item_three.five_parent.input.one) + Number(this.formteacher.item_three.five_parent.input.two)
            if (sum_itemThree_fiveParent > this.formteacher.item_three.five_parent.header) {
                sum_itemThree_fiveParent = this.formteacher.item_three.five_parent.header
            }

            let sum_itemThree_eightParent =
                Number(this.formteacher.item_three.eight_parent.input.one) + Number(this.formteacher.item_three.eight_parent.input.two)
            if (sum_itemThree_eightParent > this.formteacher.item_three.eight_parent.header) {
                sum_itemThree_eightParent = this.formteacher.item_three.eight_parent.header
            }

            let sum_itemThree =
                sum_itemThree_oneParent +
                Number(this.formteacher.item_three.two_parent.input) +
                Number(this.formteacher.item_three.three_parent.input) +
                sum_itemThree_fourParent +
                sum_itemThree_fiveParent +
                Number(this.formteacher.item_three.six_parent.input) +
                Number(this.formteacher.item_three.seven_parent.input) +
            ...
            // item four
            let sum_itemFour =
                Number(this.formteacher.item_four.one_parent.input) +
                Number(this.formteacher.item_four.two_parent.input) +
                Number(this.formteacher.item_four.three_parent.input) +
                Number(this.formteacher.item_four.four_parent.input) +
                Number(this.formteacher.item_four.five_parent.input) +
                Number(this.formteacher.item_four.six_parent.input) +
                Number(this.formteacher.item_four.seven_parent.input) +
                Number(this.formteacher.item_four.eight_parent.input) +
                Number(this.formteacher.item_four.nine_parent.input)
            ...
            let sum_itemFive_threeParent =
                Number(this.formteacher.item_five.three_parent.input.one) + Number(this.formteacher.item_five.three_parent.input.two)
            if (sum_itemFive_threeParent > this.formteacher.item_five.three_parent.header) {
                sum_itemFive_threeParent = this.formteacher.item_five.three_parent.header
            }

            let sum_itemFive_fourParent =
                Number(this.formteacher.item_five.four_parent.input.one) + Number(this.formteacher.item_five.four_parent.input.two)
            if (sum_itemFive_fourParent > this.formteacher.item_five.four_parent.header) {
                sum_itemFive_fourParent = this.formteacher.item_five.four_parent.header
            }

            let sum_itemFive_fiveParent =
                Number(this.formteacher.item_five.five_parent.input.one) + Number(this.formteacher.item_five.five_parent.input.two)
            if (sum_itemFive_fiveParent > this.formteacher.item_five.five_parent.header) {
                sum_itemFive_fiveParent = this.formteacher.item_five.five_parent.header
            }

            let sum_itemFive_sixParent =
                Number(this.formteacher.item_five.six_parent.input.one) +
                Number(this.formteacher.item_five.six_parent.input.two) +
                Number(this.formteacher.item_five.six_parent.input.three)
            if (sum_itemFive_sixParent > this.formteacher.item_five.six_parent.header) {
                sum_itemFive_sixParent = this.formteacher.item_five.six_parent.header
            }

            let sum_itemFive =
                Number(this.formteacher.item_five.one_parent.input) +
                Number(this.formteacher.item_five.two_parent.input) +
            ...
            this.formteacher.sum = sum_itemOne + sum_itemTwo + sum_itemThree + sum_itemFour + sum_itemFive

            let formData = new FormData()
            formData.append('student_id', this.student_id)
            formData.append('semester', this.semester)

            formData.append('itemOne_oneParent_inputOne', this.formteacher.item_one.one_parent.input.one)
            formData.append('itemOne_oneParent_inputTwo', this.formteacher.item_one.one_parent.input.two)
            formData.append('itemOne_oneParent_inputThree', this.formteacher.item_one.one_parent.input.three)
            formData.append('itemOne_oneParent_inputFour', this.formteacher.item_one.one_parent.input.four)
            formData.append('itemOne_oneParent_inputFive', this.formteacher.item_one.one_parent.input.five)
            formData.append('itemOne_twoParent_inputOne', this.formteacher.item_one.two_parent.input.one)
            formData.append('itemOne_twoParent_inputTwo', this.formteacher.item_one.two_parent.input.two)
            formData.append('itemOne_threeParent_inputOne', this.formteacher.item_one.three_parent.input)
            formData.append('itemOne_fourParent_inputOne', this.formteacher.item_one.four_parent.input)
            formData.append('itemOne_fiveParent_inputOne', this.formteacher.item_one.five_parent.input)
            formData.append('itemOne_sixParent_inputOne', this.formteacher.item_one.six_parent.input)

            formData.append('itemTwo_oneParent_inputOne', this.formteacher.item_two.one_parent.input)
            formData.append('itemTwo_twoParent_inputOne', this.formteacher.item_two.two_parent.input)
            formData.append('itemTwo_threeParent_inputOne', this.formteacher.item_two.three_parent.input)
            formData.append('itemTwo_fourParent_inputOne', this.formteacher.item_two.four_parent.input)
            formData.append('itemTwo_fiveParent_inputOne', this.formteacher.item_two.five_parent.input)
            formData.append('itemTwo_sixParent_inputOne', this.formteacher.item_two.six_parent.input)
            formData.append('itemTwo_sevenParent_inputOne', this.formteacher.item_two.seven_parent.input)
            formData.append('itemTwo_eightParent_inputOne', this.formteacher.item_two.eight_parent.input)

            formData.append('itemThree_oneParent_inputOne', this.formteacher.item_three.one_parent.input.one)
            formData.append('itemThree_oneParent_inputTwo', this.formteacher.item_three.one_parent.input.one)
            formData.append('itemThree_twoParent_inputOne', this.formteacher.item_three.two_parent.input)
            formData.append('itemThree_threeParent_inputOne', this.formteacher.item_three.three_parent.input)
            formData.append('itemThree_fourParent_inputOne', this.formteacher.item_three.four_parent.input.one)
            formData.append('itemThree_fourParent_inputTwo', this.formteacher.item_three.four_parent.input.two)
            formData.append('itemThree_fourParent_inputThree', this.formteacher.item_three.four_parent.input.three)
            formData.append('itemThree_fiveParent_inputOne', this.formteacher.item_three.five_parent.input.one)
            formData.append('itemThree_fiveParent_inputTwo', this.formteacher.item_three.five_parent.input.two)
            formData.append('itemThree_sixParent_inputOne', this.formteacher.item_three.six_parent.input)
            formData.append('itemThree_sevenParent_inputOne', this.formteacher.item_three.seven_parent.input)
            formData.append('itemThree_eightParent_inputOne', this.formteacher.item_three.eight_parent.input.one)
            formData.append('itemThree_eightParent_inputTwo', this.formteacher.item_three.eight_parent.input.two)

            formData.append('itemFour_oneParent_inputOne', this.formteacher.item_four.one_parent.input)
            formData.append('itemFour_twoParent_inputOne', this.formteacher.item_four.two_parent.input)
            formData.append('itemFour_threeParent_inputOne', this.formteacher.item_four.three_parent.input)
            formData.append('itemFour_fourParent_inputOne', this.formteacher.item_four.four_parent.input)
            formData.append('itemFour_fiveParent_inputOne', this.formteacher.item_four.five_parent.input)
            formData.append('itemFour_sixParent_inputOne', this.formteacher.item_four.six_parent.input)
            formData.append('itemFour_sevenParent_inputOne', this.formteacher.item_four.seven_parent.input)
            formData.append('itemFour_eightParent_inputOne', this.formteacher.item_four.eight_parent.input)
            formData.append('itemFour_nineParent_inputOne', this.formteacher.item_four.nine_parent.input)

            formData.append('itemFive_oneParent_inputOne', this.formteacher.item_five.one_parent.input)
            formData.append('itemFive_twoParent_inputOne', this.formteacher.item_five.two_parent.input)
            formData.append('itemFive_threeParent_inputOne', this.formteacher.item_five.three_parent.input.one)
            formData.append('itemFive_threeParent_inputTwo', this.formteacher.item_five.three_parent.input.two)
            formData.append('itemFive_fourParent_inputOne', this.formteacher.item_five.four_parent.input.one)
            formData.append('itemFive_fourParent_inputTwo', this.formteacher.item_five.four_parent.input.two)
            formData.append('itemFive_fiveParent_inputOne', this.formteacher.item_five.five_parent.input.one)
            formData.append('itemFive_fiveParent_inputTwo', this.formteacher.item_five.five_parent.input.two)
            formData.append('itemSix_sixParent_inputOne', this.formteacher.item_five.six_parent.input.one)
            formData.append('itemSix_sixParent_inputTwo', this.formteacher.item_five.six_parent.input.two)
            formData.append('itemSix_sixParent_inputThree', this.formteacher.item_five.six_parent.input.three)

            formData.append('sum_item', this.formteacher.sum)
