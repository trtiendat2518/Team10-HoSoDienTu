<template>
    <div>
                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table card-table table-vcenter text-nowrap table-nowrap">
                            ...
                            <tbody>
                                <tr v-show="exams.length" v-for="exam in exams" :key="exam.calendar_exam_id">
                                    <td @click="detail(exam)">
                                        <a href="javascript:void(0)">{{ exam.title }}</a>
                                    </td>
                                    <td>{{ exam.subject_name }}</td>
                                    <td>{{ exam.start | formatDate }}</td>
                                    <td>{{ exam.end | formatDate }}</td>
                                    <td style="text-align: center">
                                        <button class="btn-3d btn btn-success btn-lg fa fa-pencil-square-o" @click="show(exam)"></button>
                                    </td>
                                    <td>
                                        <button
                                            class="btn-3d btn btn-danger btn-lg fa fa-trash"
                                            @click="destroy(exam.calendar_exam_id)"
                                        ></button>
                                    </td>
                                </tr>
                        ...
                        <pagination
                            ...
                            :offset="5"
                            @paginate="query === '' ? fetchExams() : search()"
                        ></pagination>
                    </div>
                    <!-- table-responsive -->
                </div>
        ...
        <div
            ...
            tabindex="-1"
            role="dialog"
            aria-labelledby="ExamModalTitle"
            aria-hidden="true"
        >
                ...
                <form @submit.prevent="editMode ? update() : store()" @keydown="form.onKeydown($event)">
                    ...
                    <div class="modal-content">
                        <div class="modal-header styling-modal-header-update">
                            <h5 class="modal-title" id="ExamModalTitle">{{ editMode ? 'Cập nhật' : 'Thêm mới' }} Lịch thi</h5>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select
                                            v-model="form.calendar_exam_subject"
                                            name="calendar_exam_subject"
                                        ...
                                        <div
                                            ...
                                            v-if="form.errors.has('calendar_exam_subject')"
                                            v-html="form.errors.get('calendar_exam_subject')"
                                        ></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select
                                            v-model="form.calendar_exam_method"
                                        ...
                                        <div
                                            class="text-danger mb-3"
                                            v-if="form.errors.has('calendar_exam_method')"
                                            v-html="form.errors.get('calendar_exam_method')"
                                        ></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select
                                    v-model="form.calendar_exam_schedule"
                                ...
                                <div
                                    class="text-danger mb-3"
                                    v-if="form.errors.has('calendar_exam_schedule')"
                                    v-html="form.errors.get('calendar_exam_schedule')"
                                ></div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div
                                            ...
                                            v-html="form.errors.get('calendar_exam_room')"
                                        ></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input
                                            type="text"
                                            v-model="form.calendar_exam_place"
                                            name="calendar_exam_place"
                                            class="form-control"
                                        ...
                                        <div
                                            class="text-danger mb-3"
                                            v-if="form.errors.has('calendar_exam_place')"
                                            v-html="form.errors.get('calendar_exam_place')"
                                        ></div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div
                                            ...
                                            v-html="form.errors.get('calendar_exam_semester')"
                                        ></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div
                                    ...
                                    v-html="form.errors.get('calendar_exam_note')"
                                ></div>
                            </div>
                        </div>
        ...
        >
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <table class="table table-borderless w-100 m-0 " v-for="detail in details" :key="detail.caledar_exam_id">
                            <tbody class="col-lg-6 p-0">
                                ...
                                <tr>
                                    <td>
                                        Tiêu đề: <strong> {{ detail.title }}</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        Phòng thi: <strong> {{ detail.calendar_exam_room }}</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        Địa điểm: <strong> {{ detail.calendar_exam_place }}</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        Môn học: <strong> {{ detail.subject_name }}</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        Bắt đầu: <strong> {{ detail.start | formatFullTime }}</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        Kết thúc: <strong> {{ detail.end | formatFullTime }}</strong>
                                    </td>
                                </tr>
                            </tbody>
                            <tbody class="col-lg-6 p-0">
...
export default {
    ...
    methods: {
        ...
        fetchSchedules(page_url) {
            let vm = this
            page_url = '../../api/admin/calendar-schedule/lich-bieu/schedule-exam'
            fetch(page_url)
                .then(res => res.json())
                .then(res => {
        ...
        store() {
            this.form.busy = true
            this.form
                .post('../../api/admin/calendar-exam/lich-thi')
                .then(res => {
                    this.fetchExams()
        ...
        update() {
            this.form
                .put(`../../api/admin/calendar-exam/lich-thi/${this.form.calendar_exam_id}`)
                .then(res => {
                    this.fetchExams()
                    $('#ExamModal').modal('hide')
                    if (this.form.successful) {
                ...
                buttons: [
                    {
                        ...
                        action: toast => {
                            ...
                            axios
                                .delete(`../../api/admin/calendar-exam/lich-thi/${calendar_exam_id}`)
                                .then(res => {
