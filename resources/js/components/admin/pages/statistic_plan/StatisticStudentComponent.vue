...
export default {
    ...
    methods: {
        ...
        fetchStudentRegistered(page_url) {
            let vm = this
            page_url = `../../api/admin/register-plan/dang-ky-ke-hoach-hoc-tap-sv/da-dang-ky/${this.course_id}/${this.major_id}/${this.semester}`
            fetch(page_url)
                .then(res => res.json())
                .then(res => {
                    ...
                    let value = Object.keys(registers)
