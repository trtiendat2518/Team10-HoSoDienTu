                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <select
                                    ...
                                    :class="{ 'is-invalid': form.errors.has('education_program_type') }"
                                >
                                    ...
                                    <option
                                        ...
                                        :hidden="type.program_type_status > 0"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select
                                    ...
                                    :class="{ 'is-invalid': form.errors.has('education_program_course') }"
                                >
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    :class="{ 'is-invalid': form.errors.has('education_program_code') }"
                                    placeholder="Nhập mã cho CTĐT"
                                />
                                <div
                                    class="text-danger"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input
                                    type="number"
                                    name="education_program_year"
                                    class="form-control"
                                    v-model="form.education_program_year"
                                    :class="{ 'is-invalid': form.errors.has('education_program_year') }"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select
                                    class="form-control"
                                    name="education_program_status"
                                    v-model="form.education_program_status"
                                    :class="{ 'is-invalid': form.errors.has('education_program_status') }"
                                >
                                    <option value="" disabled selected="">
                                        Chọn Trạng thái
                                    </option>
                                ...
                                <div
                                    class="text-danger"
                                    v-if="form.errors.has('education_program_status')"
                                    v-html="form.errors.get('education_program_status')"
                                ></div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        store() {
            ...
            this.form
                .post('../../api/admin/program/chuong-trinh-dao-tao')
                .then(res => {
