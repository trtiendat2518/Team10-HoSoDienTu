            ...
            <div class="" v-show="noti == true">
                ...
                >
                    ...
                    <div class="content-wrap">
                        {{ notification.student_fullname }} đã gửi yêu cầu:
                        <strong>{{ notification.request_title.substring(0, 30) + '...' }}</strong>
...
export default {
    ...
    methods: {
        fetchNotification(page_url) {
            page_url = `../../api/admin/notification/thong-bao/gvcn/${this.formteacher_id}`
            fetch(page_url)
                .then(res => res.json())
                .then(res => {
