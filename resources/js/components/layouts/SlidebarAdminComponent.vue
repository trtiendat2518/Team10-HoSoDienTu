            ...
            <div class="tab-content">
                <div class="tab-pane active ">
                    <ul class="side-menu toggle-menu">
                        ...
                        <li class="mt-5 mb-2 ml-4"><span class="side-menu__label"><strong class="color-text">QUẢN LÝ TÀI KHOẢN</strong></span></li>
                        <li class="slide">
                        ...
                        <li class="mt-5 mb-2 ml-4"><span class="side-menu__label"><strong class="color-text">QUẢN LÝ CHUNG</strong></span></li>
                        <li class="slide">
